import { 
  ...
  FaLinkedin, 
  FaTwitter, 
  FaDownload , FaTiktok, FaTerminal
} from 'react-icons/fa';
...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden md:block bg-[#1e1e1f] border border-[#383838] p-6 text-center shadow-2xl  flex-col justify-between h-full">
